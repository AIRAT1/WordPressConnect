...
import de.android.wordpressconnect.MainActivity;
...
public class WordpressFragment extends Fragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        @SuppressLint("RestrictedApi") View footerView = getLayoutInflater(savedInstanceState).inflate(R.layout.listview_footer, null);
